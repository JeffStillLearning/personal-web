...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    bullets: ['Semua yang ada di Landing Page, plus:', 'Hingga 5 halaman (Home, About, Services, Portfolio, Contact)', 'Desain visual lebih kompleks (CTA, Form, Galeri)', 'WhatsApp Chat langsung', '1 Email Bisnis', 'Free Hosting 1 Tahun', '10 GB Disk Storage', '3x Revisi Gratis', 'SEO On-Page', 'Garansi Maintenance 1 Bulan'],
    accent: '#00B4D8',
    bg: '#E7F7FB',
  },
  {
    ...
    desc: 'Punya kebutuhan lebih dari sekedar website? Mulai dari sistem reservasi online, pembayaran, hingga pengelolaan data pelanggan semua bisa disesuaikan. Ceritakan kebutuhan Anda, saya buatkan solusinya.',
    bullets: ['Semua yang ada di Company Profile, plus:', 'Hingga 8+ halaman', 'Fitur custom sesuai kebutuhan bisnis Anda', 'Animasi interaktif', 'Integrasi API / Payment Gateway (jika dibutuhkan)', 'Speed Optimization', '5x Revisi Gratis', 'Garansi Maintenance 1,5 Bulan', 'AI Search Optimization'],
    accent: '#7A5AE0',
    bg: '#F1ECFE',
  },
];
